<?php
     ...
     */
    add_action('rest_api_init', 'nuxtpress_generate_route');


    function nuxtpress_generate_route() {
        register_rest_route('nuxtpress', '/v1/generate', array(
            'methods'  => 'GET',
            'callback' => 'nuxtpress_get_generate_urls'
        ));
    }


    function nuxtpress_get_generate_urls( $object ) {
