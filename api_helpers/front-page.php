<?php
     ...
     * Front-end
     */
    add_action('rest_api_init', 'nuxtpress_front_page_route');


    function nuxtpress_front_page_route() {
        register_rest_route('nuxtpress', '/v1/front-page', array(
            'methods'  => 'GET',
            'callback' => 'nuxtpress_get_front_page'
        ));
    }


    function nuxtpress_get_front_page( $object ) {
