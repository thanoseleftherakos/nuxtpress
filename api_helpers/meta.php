<?php
     ...
     */
    add_action( 'init', 'nuxtpress_register_acf_meta' );
    add_action( 'init', 'nuxtpress_register_yoast_meta' );

    function nuxtpress_register_acf_meta() {
    ...
    function nuxtpress_register_yoast_meta() {
